...
const EVENTS: Event[] = [
  ...
  {
    id: '6',
    title: 'Мастер-класс по сервировке <br /> стола и этикету',
    date: '16 июня',
    time: '12:00',
    duration: '2 часа',
    location: 'Пространство [PRO]SEC.CO creativo, ул. Почтамтская, 13 (Санкт-Петербург)',
    description: 'Учимся превращать обычный ужин в акт любви к себе. Сервировка, этикет и магия деталей — в камерном пространстве с ужином и шампанским.',
    longDescription: 'Красота за столом — это не только о правильном положении вилки, но и об отношении к себе и окружающим. \n\nВ изысканной атмосфере мы разберем основы светского этикета, которые дают ту самую уверенность и легкость в любом обществе. \n\nВы узнаете секреты Pinterest-сервировки и как создавать магию из привычных вещей. \n\nЗавершим мастер-класс ужином с историей в пространстве, где обсудим традиции гостеприимства и эстетики. \n\nВ стоимость включены: ужин, бокал шампанского и подарки от организаторов.',
    image: dishesImg,
    price: '4 900 ₽',
    category: 'Мастер-класс',
    host: {
      name: 'Светлана Прохорова',
      role: 'эксперт по сервировке стола и этикету',
      image: svetlanaImg,
    ...
    program: [
      ...
      'Практика с коллекционным европейским винтажом пространства',
      'Ужин с историей и бокал шампанского',
      'Подарки от организаторов и фотосъемка вечера'
    ]
  },
  {
    id: '1',
  ...
  },
  {
    ...
    description: 'Частная яхта в Финском заливе — только 5 участниц. Роскошь открытой воды, игристое на палубе и ощущение абсолютной свободы.',
    longDescription: 'Есть чувство, которое нельзя купить — но можно прожить.\n\nБелоснежный парус над головой, ветер с запахом соли и воды, растворяющаяся вдали линия Санкт-Петербурга — всё это происходит на палубе частной яхты, зарезервированной только для нас пятерых.\n\nИзысканный фуршет с игристым и лёгкими закусками прямо на воде. Профессиональная фотосессия в стиле «Yacht Vogue» — снимки, которые хочется рассматривать бесконечно.\n\nЭто не просто день на яхте. Это день, когда город остаётся далеко на берегу, шум утихает, а внутри наконец появляется то, о чём давно забыла — ощущение абсолютной свободы.',
    image: yachtImg,
    price: '12 000 ₽',
    ...
    program: [
      ...
      'Изысканный фуршет: игристое, лёгкие закуски, фрукты на воде',
      'Фотосессия в стиле «Yacht Vogue» с профессиональным фотографом',
      'Видео-рил: память о дне, когда вы чувствовали море и свободу'
    ]
  },
  {
    id: '8',
  ...
  },
  {
    ...
    program: [
      ...
      'Что меняется, когда разрешаешь себе хотеть красиво',
      'Живой разговор и практика с вопросами',
      'Первый шаг к мечте, которую вы выбираете для себя'
    ]
  }
];
...
const FormatsSection = () => {
  const formats = [
    ...
    { title: 'Тело и Грация', icon: <Music size={20} />, items: ['Пилатес в особняках', 'Женская йога'] },
