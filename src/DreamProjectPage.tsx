...
const facts = ['5 прямых эфиров', 'Рабочая тетрадь', 'Задания', 'Промты для ИИ', 'Записи встреч'];
  ...
  return (
    <main className="dream-page">
      ...
      <section className="dream-section dream-process dream-shell">
        ...
        <div className="dream-heading-row"><h2>Пять дней.<br/><em>Одна мечта.</em></h2><p>Каждый день — прямой эфир около 30 минут, одна тема и один следующий этап. Запись встречи сохраняется.</p></div>
