  ...
  return (
    <main className="dream-page">
      ...
      <section id="tariffs" className="dream-section dream-tariffs dream-shell">
        ...
        <div className="dream-cohort"><h3>Второй поток программы<br/><em>«Мечта как проект»</em></h3><div><p>Обновлённая и дополненная методология, созданная с учётом результатов, обратной связи и реального опыта участниц первого потока.</p></div></div>
      </section>
